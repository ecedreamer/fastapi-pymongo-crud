...
from article import db_helpers
...
class ArticleCrudTest(unittest.TestCase):
    ...
    def test_article_helper(self):
        serializable_article = db_helpers.article_helper(self.article_in_db)
    ...
    def test_article_list(self, mock_find):
        ...
        articles = db_helpers.article_list()
    ...
    def test_article_detail(self, mock_find_one):
        ...
        article = db_helpers.article_detail("1234567890ab1234567890ab")
    ...
    def test_article_update(self, mock_find_one, mock_update_one):
        ...
        updated_article = db_helpers.article_update("1234567890ab1234567890ab", (("title", "Modified title"),))
        mock_find_one.assert_called_once()
    ...
    def test_article_delete(self, mock_delete_one):
        ...
        delete_status = db_helpers.article_delete("1234567890ab1234567890ab")
